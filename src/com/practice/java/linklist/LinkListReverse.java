...
public class LinkListReverse {
	...
	private Node reverseList(Node currentNode) {
		...
		while(currentNode != null) {
			...
			//System.out.println("Current.next: "+currentNode.next.toString());
			//System.out.println("Previous: "+previousNode.toString());
	...
	public Node nthFromLastNode(Node nNode,int n){
		Node firstPtr = nNode;
